      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="text-center mb-4">
          <p className="text-xs mb-1" style={{ color: '#999999' }}>
            {t('kiosk.screens.complete.congrats', '주문이 완료되었습니다')}
          </p>
          <div
          ...
          <p className="text-xs mt-2" style={{ color: '#999999' }}>
            {t('kiosk.screens.complete.message', '번호판이 호출되면 수령하세요')}
          </p>
        </div>
        ...
        >
          ...
          <div className="bg-white px-4 py-3">
            ...
            <div className="space-y-1 mb-3">
              <div className="flex justify-between">
                <span className="text-xs" style={{ color: '#555555' }}>
                  {t('kiosk.screens.complete.amount', '공급가액')}
                </span>
              ...
              <div className="flex justify-between">
                <span className="text-xs" style={{ color: '#555555' }}>
                  {t('kiosk.screens.complete.tax', '부가세')}
                </span>
                <span className="text-xs" style={{ color: '#1A1A1A' }}>
                  {formatPrice(tax)}원
                </span>
              ...
              >
                <span className="font-bold text-sm" style={{ color: '#1A1A1A' }}>
                  {t('kiosk.screens.complete.total', '합계')}
                </span>
              ...
              <div className="flex justify-between">
                <span className="text-xs" style={{ color: '#555555' }}>
                  {t('kiosk.screens.complete.cardName', '결제수단')}
                </span>
                <span className="text-xs" style={{ color: '#1A1A1A' }}>
                  {t('kiosk.screens.complete.lumpSum', '신용카드 일시불')}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-xs" style={{ color: '#555555' }}>
                ...
                <span className="text-xs font-mono" style={{ color: '#1A1A1A' }}>
                  {t('kiosk.screens.complete.cardNumber', '****-****-****-1234')}
                </span>
              </div>
            </div>
            ...
            <p className="text-center font-bold text-sm" style={{ color: '#1A1A1A' }}>
              {t('kiosk.screens.complete.thanks', '감사합니다')}
            </p>
            <p className="text-center text-xs mt-1" style={{ color: '#999999' }}>
              {t('kiosk.screens.complete.paymentDetail', 'IC 승인')}
            </p>
          </div>
        </div>
      </div>
